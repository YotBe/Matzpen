...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  he: {
    ...
    'nav.about': 'אודות',
    'nav.aboutHelper': 'הסיפור מאחורי מצפן',
    'nav.organizations': 'לארגונים',
    'nav.organizationsHelper': 'קופות חולים, עמותות ובתי חולים',

    // ── Patient onboarding ─────────────────────────────────────────────────
    'onboarding.patient.step1.title': 'מי האדם שאתם מלווים?',
    'onboarding.patient.step1.body': 'כדי שמצפן יוכל לעזור לכם בצורה הטובה ביותר, ספרו לנו קצת על האדם שאתם תומכים בו.',
    'onboarding.patient.step2.title': 'מה האבחנה הידועה?',
    'onboarding.patient.step2.body': 'ניתן לרשום בחופשיות — אין צורך במינוח רפואי מדויק. אפשר גם לדלג אם עדיין לא ידוע.',
    'onboarding.patient.step3.title': 'מה הסיטואציה עכשיו?',
    'onboarding.patient.step3.body': 'ההערכה הזו עוזרת לנו להתאים את ברירות המחדל עבורכם.',
    'onboarding.patient.namePlaceholder': 'שם פרטי',
    'onboarding.patient.diagnosisPlaceholder': 'תאר את האבחנה בחופשיות…',
    'onboarding.patient.saving': 'שומר…',
    'onboarding.patient.done': 'בואו נתחיל',
    'onboarding.patient.relationship.spouse': 'בן/בת זוג',
    'onboarding.patient.relationship.child': 'ילד/ה',
    'onboarding.patient.relationship.parent': 'הורה',
    'onboarding.patient.relationship.sibling': 'אח/ות',
    'onboarding.patient.relationship.other': 'אחר',
    'onboarding.patient.chip.depression': 'דיכאון',
    'onboarding.patient.chip.bipolar': 'הפרעה דו-קוטבית',
    'onboarding.patient.chip.schizophrenia': 'סכיזופרניה',
    'onboarding.patient.chip.anxiety': 'חרדה',
    'onboarding.patient.chip.other': 'אחר',
    'onboarding.patient.situation.stable': 'יציב',
    'onboarding.patient.situation.deteriorating': 'בהידרדרות',
    'onboarding.patient.situation.crisis': 'משבר חריף',
  ...
  en: {
    ...
    'nav.terms': 'Terms',
    'nav.about': 'About',
    'nav.aboutHelper': 'The story behind Matzpen',
    'nav.organizations': 'For Organizations',
    'nav.organizationsHelper': 'HMOs, nonprofits & hospitals',

    // Patient onboarding
    'onboarding.patient.step1.title': 'Who are you supporting?',
    'onboarding.patient.step1.body': 'Tell us a little about the person you are caring for so Matzpen can help you best.',
    'onboarding.patient.step2.title': 'What is the known diagnosis?',
    'onboarding.patient.step2.body': 'Feel free to use plain language — no need for medical jargon. You can also skip if unknown.',
    'onboarding.patient.step3.title': 'What is the current situation?',
    'onboarding.patient.step3.body': 'This helps us set the right defaults for you.',
    'onboarding.patient.namePlaceholder': 'First name',
    'onboarding.patient.diagnosisPlaceholder': 'Describe the diagnosis freely…',
    'onboarding.patient.saving': 'Saving…',
    'onboarding.patient.done': "Let's start",
    'onboarding.patient.relationship.spouse': 'Spouse / partner',
    'onboarding.patient.relationship.child': 'Child',
    'onboarding.patient.relationship.parent': 'Parent',
    'onboarding.patient.relationship.sibling': 'Sibling',
    'onboarding.patient.relationship.other': 'Other',
    'onboarding.patient.chip.depression': 'Depression',
    'onboarding.patient.chip.bipolar': 'Bipolar disorder',
    'onboarding.patient.chip.schizophrenia': 'Schizophrenia',
    'onboarding.patient.chip.anxiety': 'Anxiety',
    'onboarding.patient.chip.other': 'Other',
    'onboarding.patient.situation.stable': 'Stable',
    'onboarding.patient.situation.deteriorating': 'Deteriorating',
    'onboarding.patient.situation.crisis': 'Acute crisis',
